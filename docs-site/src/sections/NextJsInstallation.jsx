...
export default function NextJsInstallation() {
  return (
    <DocSection id="nextjs-installation" title="NextJs Installation">
      <div className="space-y-8">
        <div id="nextjs-step-1" className="scroll-mt-40 space-y-3">
          <h3 className="mt-5 text-base font-semibold text-slate-900">Step 1: Copy and add the script</h3>
          <p className="text-base text-slate-700">Copy this script function, store it in a variable named AIXEL_BOOTSTRAP within code <code>layout.tsx</code>, and include it in the HTML returned by the layout.</p>
          <img src="./install.png" alt="Install the script" />
          <CodeBlock className="text-wrap break-words"
            code={`const AIXEL_BOOTSTRAP = \`!function()...{apiHost:'https://data-log.aixel.io'});\`;
    ...
    className={\`\${geistSans.variable} \${geistMono.variable} h-full antialiased\`}>
      <body className="min-h-full flex flex-col font-sans">
        ...
        <Script
            ...
            dangerouslySetInnerHTML={{ __html: AIXEL_BOOTSTRAP }}
        />
...
`}
        ...
        <div id="nextjs-step-2" className="scroll-mt-40 space-y-3">
...
`}
        ...
        <div id="nextjs-step-3" className="scroll-mt-40 space-y-3">
          ...
          <CodeBlock
            code={`import { identify } from "@/lib/pixel";
...
`}
        ...
        <div id="nextjs-step-4" className="scroll-mt-40 space-y-3">
...
<CodeBlock
            code={`import { trackEvent } from "@/lib/pixel";
